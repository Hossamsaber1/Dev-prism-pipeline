...
<a href='https://prism-pipeline.com/' style="color: rgb(150,200,250)">www.prism-pipeline.com</a>""" % (
    ...
    def saveScene(
        ...
        if prismReq:
            ...
            if versionUp:
                ...
                fnameData = self.paths.getDefaultWorkContext(
                    fnameData, reason="save scene version-up"
                )
                ...
                fVersion = self.getHighestVersion(
                    fnameData,
        ...
        if curfile:
            ...
            detailData = self.paths.getDefaultWorkContext(
                detailData, reason="save scene detail data"
            )
            ...
            if key:
                ...
                if not pathdata:
                    # Compatibility patch: simplified scenefiles don't include
                    # legacy department/task folders in the filepath.
                    pathdata = self.paths.getSimplifiedScenefileData(filepath)
    ...
    def updateEnvironment(self):
        ...
        data = self.paths.getDefaultWorkContext(data, reason="environment update")
